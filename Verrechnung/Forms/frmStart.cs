...
namespace Verrechnung
{
    public partial class frmStart : Form
    {
        ...
        private void btnKunde_Click(object sender, EventArgs e)
        {
            ...
            {
                btnKunde.BackColor = btnForeColor;
        ...
        private void btnAlleSchliessen_Click(object sender, EventArgs e)
        {
        ...
        private void btnProgrammSchliessen_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
